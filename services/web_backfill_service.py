...
FALLBACK_BACKFILL_DOMAINS = ['thehackernews.com']
BACKFILL_QUERY_SUFFIXES = ['report', 'ransomware', 'ttp', 'attack technique', 'writeup']
BACKFILL_MAX_SECONDS = 22.0
BACKFILL_SEARCH_TIMEOUT_SECONDS = 4.0
BACKFILL_FETCH_TIMEOUT_SECONDS = 10.0
BACKFILL_QUERY_BUDGET = 20
